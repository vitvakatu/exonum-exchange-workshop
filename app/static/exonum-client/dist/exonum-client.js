...
},{"./helpers/bind":15,"is-buffer":33}],26:[function(require,module,exports){
'use strict'
...
},{"base64-js":26,"ieee754":31}],31:[function(require,module,exports){
...
},{"./hash":36,"inherits":32,"safe-buffer":35}],39:[function(require,module,exports){
/*
...
},{"./hash":36,"inherits":32,"safe-buffer":35}],40:[function(require,module,exports){
/**
...
},{"./hash":36,"./sha256":41,"inherits":32,"safe-buffer":35}],41:[function(require,module,exports){
/**
 * A JavaScript implementation of the Secure Hash Algorithm, SHA-256, as defined
 * in FIPS 180-2
 * Version 2.2-beta Copyright Angel Marin, Paul Johnston 2000 - 2009.
...
},{"./hash":36,"inherits":32,"safe-buffer":35}],42:[function(require,module,exports){
var inherits = require('inherits')
...
},{"./hash":36,"./sha512":43,"inherits":32,"safe-buffer":35}],43:[function(require,module,exports){
var inherits = require('inherits')
var Hash = require('./hash')
var Buffer = require('safe-buffer').Buffer
...
},{"./hash":36,"inherits":32,"safe-buffer":35}],44:[function(require,module,exports){
(function(nacl) {
'use strict';
...
},{"crypto":29}],45:[function(require,module,exports){
'use strict';
...
},{"../types/convert":55,"../types/generic":56,"../types/hexadecimal":57,"../types/primitive":60}],46:[function(require,module,exports){
'use strict';
...
var Block = (0, _generic.newType)({
  fields: [{ name: 'proposer_id', type: primitive.Uint16 }, { name: 'height', type: primitive.Uint64 }, { name: 'tx_count', type: primitive.Uint32 }, { name: 'prev_hash', type: _hexadecimal.Hash }, { name: 'tx_hash', type: _hexadecimal.Hash }, { name: 'state_hash', type: _hexadecimal.Hash }]
});
...
},{"../crypto":51,"../helpers":52,"../types/generic":56,"../types/hexadecimal":57,"../types/message":59,"../types/primitive":60,"../types/validate":62}],47:[function(require,module,exports){
'use strict';
...
},{"./block":46,"./merkle":49,"./merkle-patricia":48,"./transport":50}],48:[function(require,module,exports){
'use strict';
...
},{"../crypto":51,"../types/generic":56,"../types/hexadecimal":57,"./ProofPath":45,"binary-search":28}],49:[function(require,module,exports){
'use strict';
...
},{"../crypto":51,"../helpers":52,"../types/convert":55,"../types/generic":56,"../types/validate":62,"big-integer":27}],50:[function(require,module,exports){
'use strict';
...
},{"../helpers":52,"../types/message":59,"../types/validate":62,"axios":1}],51:[function(require,module,exports){
'use strict';
...
},{"../types/convert":55,"../types/generic":56,"../types/message":59,"../types/validate":62,"big-integer":27,"sha.js":37,"tweetnacl":44}],52:[function(require,module,exports){
'use strict';
...
},{"./blockchain":47,"./crypto":51,"./types":58}],54:[function(require,module,exports){
'use strict';
...
},{"./serialization":61}],55:[function(require,module,exports){
'use strict';
...
},{"../types/validate":62}],56:[function(require,module,exports){
'use strict';
...
},{"../crypto":51,"./primitive":60,"./serialization":61}],57:[function(require,module,exports){
'use strict';
...
},{"./validate":62}],58:[function(require,module,exports){
'use strict';
...
},{"./array":54,"./convert":55,"./generic":56,"./hexadecimal":57,"./message":59,"./primitive":60}],59:[function(require,module,exports){
'use strict';
...
var NewMessage = function () {
  ...
  _createClass(NewMessage, [{
    ...
    key: 'send',
    value: function send(transactionEndpoint, explorerBasePath, data, signature, timeout, attempts) {
      return (0, _transport.send)(transactionEndpoint, explorerBasePath, data, signature, this, timeout, attempts);
    }
  }]);
...
},{"../blockchain/transport":50,"../crypto":51,"./generic":56,"./hexadecimal":57,"./primitive":60,"./serialization":61}],60:[function(require,module,exports){
'use strict';
...
},{"./validate":62,"big-integer":27,"ieee754":31}],61:[function(require,module,exports){
'use strict';
...
function serialize(buffer, shift, data, type, isTransactionBody) {
  ...
  function serializeInstanceofOfNewArray(buffer, shift, from, data, type) {
    ...
    _primitive.Uint32.serialize(buffer.length - shift, buffer, from); // start index
...
},{"./array":54,"./generic":56,"./primitive":60}],62:[function(require,module,exports){
'use strict';
 ...
 * @returns {*}
 */
function validateBigInteger(value, min, max, from, length) {
  ...
  var val = void 0;
  try {
    val = (0, _bigInteger2.default)(value);
  } catch (error) {
    return false;
  }
 ...
 * @returns {boolean}
 */
function validateFloat(value, from, length) {
